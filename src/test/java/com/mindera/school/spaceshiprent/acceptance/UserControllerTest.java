...
public class UserControllerTest {
    ...
    public void test_getUserById_shouldReturn404() {
        ...
        assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode(), "status code");
        assertEquals("UserNotFoundException", Objects.requireNonNull(response.getBody()).getException(), "exception name");
    }
